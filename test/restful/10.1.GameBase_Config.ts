    ...
    describe('Register and CRUD Setting', () => {
        ...
        describe('CRUD Setting', () => {
            ...
            describe('Create/Update', () => {
              ...
              it('create', (done) => {
                chai.request(baseURL)
                  .post(`/api/user/${entity.privileges.actions[actionIndex].methods[2]}`)
                  .set('authentication-key', loggedUser.authenticationKey)
                  .set('access-key', loggedUser.accessKey)
                  .send({
                    async: false,
                  ...
                  .end((error, response) => {
                    ...
                    expect(response.body.success).to.be.true;
                    expect(response.body.data).to.be.instanceof(Object);
                    expect(response.body.data).to.have.all.keys("async", "timer", "time", "isDefault", "removed", "playersPerTeam", "id", "createdAt", "updatedAt");
                    done();
                  });
              });
              ...
              it('update', (done) => {
                chai.request(baseURL)
                  ...
                  .end((error, response) => {
                    ...
                    expect(response.body.success).to.be.true;
                    expect(response.body.data).to.be.instanceof(Object);
                    expect(response.body.data).to.have.all.keys("async", "timer", "time", "isDefault", "removed", "playersPerTeam", "id", "createdAt", "updatedAt", "__v");
                    done();
                  });
              });
            ...
            describe('Delete', () => {
              ...
              it('OK', (done) => {
                chai.request(baseURL)
                  .delete(`/api/user/${entity.privileges.actions[actionIndex].methods[2]}`)
                  .set('authentication-key', loggedUser.authenticationKey)
                  .set('access-key', loggedUser.accessKey)
                  .end((error, response) => {
                    expect(response.body).to.be.instanceof(Object);
                    ...
                    expect(response.body.success).to.be.true;
                    expect(response.body.data).to.be.instanceof(Object);
                    expect(response.body.data).to.have.all.keys("async", "timer", "time", "isDefault", "removed", "playersPerTeam", "id", "createdAt", "updatedAt", "__v", "_id");
                    done();
                  });
              });
